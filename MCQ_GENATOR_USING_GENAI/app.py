...
app = Flask(__name__)           #app is created
app.config['UPLOAD_FOLDER'] = 'uploads/'     #store global configuration setting
...
def save_mcqs_to_file(mcqs, filename):
    results_path = os.path.join(app.config['RESULTS_FOLDER'], filename)  #create file path 
    with open(results_path, 'w') as f:
        f.write(mcqs)  # it write generated mcq to file
    return results_path
...
@app.route('/')                    #route decorator for the main page                                                           
def index():                                       
